...
parser.add_argument("--save_dir", type=str, default='best_model3', help="directory where you save models")
...
def sample_image(n_row, batches_done, current_epoch):
    ...
    gen_imgs = decoder(z)
    save_image(gen_imgs.data, "imagest3/epoch_%d.png" % current_epoch, nrow=n_row, normalize=True)
...
for epoch in range(opt.n_epochs):
    ...
    for i, (imgs, _) in enumerate(trainloader):
        ...
        top_loss = top_loss / (100*decoded_imgs.size(0))
