...
parser.add_argument("--save_dir", type=str, default='latest_model/loss_mse/lr_0.0002', help="directory where you save models")
...
def sample_image(n_row, batches_done, current_epoch, img):
    ...
    # Sample noise
    save_image(img.data, "images/loss_mse/lr_0.0002/with_original/epoch_%d.png" % current_epoch, nrow=n_row, normalize=True)
...
for epoch in range(opt.n_epochs):
    ...
    if epoch_valid_g_loss < best_val_loss:
        ...
        #torch.save(discriminator, os.path.join(opt.save_dir, 'discriminator_%03d.pth' % (epoch)))
    '''      
    writer.add_scalars('LR=0.0002, MSE 1e-5, epsilon=15', {
