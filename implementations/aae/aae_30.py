...
parser.add_argument("--save_dir", type=str, default='best_model30', help="directory where you save models")
...
def sample_image(n_row, batches_done, current_epoch):
    ...
    gen_imgs = decoder(z)
    save_image(gen_imgs.data, "imagest30/epoch_%d.png" % current_epoch, nrow=n_row, normalize=True)
